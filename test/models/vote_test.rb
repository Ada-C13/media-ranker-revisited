...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(username: "somename") }
    let (:user2) { User.new(username: "somename") }
    let (:work1) { Work.new(category: "book", title: "sample book") }
    let (:work2) { Work.new(category: "book", title: "sample title") }
