...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(username: "chris", email: "chris@ada.org", provider: "ada-test", uid: 56789) }
    let (:user2) { User.new(username: "chris", email: "chris@ada.org", provider: "ada-test", uid: 56789) }
