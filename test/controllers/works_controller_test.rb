...
describe WorksController do
  describe 'guest user' do
    ...
    describe "index" do
      it "should not allow guest to access index" do
        get works_path

        expect( flash[:status] ).must_equal :warning
        expect( flash[:result_text] ).must_equal "Must be logged in to access that feature"
    ...
    describe "new" do
      it "should not allow guest to access new form" do
        get new_work_path
    ...
    describe "create" do
      it "should not allow a guest to create a new work" do
    ...
    describe "show" do
      it "should not allow a guest to access show page" do
    ...
    describe "edit" do
      it "should not allow a guest to access edit form" do
    ...
    describe "update" do
      it "should not allow a guest to edit work" do
    ...
    describe "destroy" do
      it "should not allow a guest to delete work" do
        expect {
    ...
    describe "upvote" do
      it "redirects to the work page if no user is logged in" do
        work = works(:movie)
        expect{ post upvote_path(work) }.wont_change 'Vote.count'
  ...
  describe 'logged in user' do
    ...
    describe "upvote" do
      it "succeeds for a logged-in user and a fresh user-vote pair" do
        diff_work = (works(:movie))
        expect{ post upvote_path(diff_work) }.must_change 'Vote.count', 1

        expect(flash[:result_text]).must_equal 'Successfully upvoted!'
        must_redirect_to work_path(diff_work)
      end
