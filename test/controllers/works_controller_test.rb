...
describe WorksController do
  ...
  describe "logged in users" do
    ...
    describe "upvote" do
      # TODO I comment this test, since we are inside of the login user.
      # TODO It does not make sense to use this test. Since an guest user is not allowed to see this page.
  ...
  describe "guest users" do
    ...
    describe "update" do
      it "succeeds for valid data and an extant work ID" do
        ...
        expect(updated_work.title).wont_equal "Dirty Computer"
        must_respond_with :redirect
        must_redirect_to root_path
      end
