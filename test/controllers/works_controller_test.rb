...
describe WorksController do
  ...
  describe "guest" do
    ...
    describe "create" do
      it "redirects when trying to create a work with valid data for a real category" do
        new_work = { work: { title: "Dirty Computer", category: "album" } }
      ...
      it "redirects and does not update the DB" do
        bad_work = { work: { title: nil, category: "book" } }
      ...
      it "redirects adding categories" do
        INVALID_CATEGORIES.each do |category|
          invalid_work = { work: { title: "Invalid Work", category: category } }
  
          expect { 
            post works_path, params: invalid_work 
          }.wont_change "Work.count"
